<nav class="profile-nav  bg-white">
    <ul class="nav align-items-center">
        ...
        <li class="nav-item @if(str_contains(url()->current(), 'page/photo/view/')) active @endif"><a href="{{ route('single.page.photos',$page->id) }}" class="nav-link">{{ get_phrase('Photos & Reels') }}</a></li>
