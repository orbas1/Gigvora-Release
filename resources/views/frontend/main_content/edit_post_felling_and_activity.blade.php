<div class="post-inner" id="tab-feeling{{$post->post_id}}">
    
    <div class="tag-wrap">
        <a href="javascript:void(0)" onclick="$('#tab-feeling{{$post->post_id}}').hide()" class="prev-btn"><i class="fa fa-long-arrow-left"></i></a>

        <div class="post-tagged mt-3">
            <div class="tag-card" id="feeling_and_activities{{$post->post_id}}">
            </div>
        </div>
