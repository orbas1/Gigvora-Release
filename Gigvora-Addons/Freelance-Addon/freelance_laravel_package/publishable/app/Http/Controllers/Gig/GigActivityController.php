...
class GigActivityController extends Controller
{
    ...
    public function index( $slug, Request $request){
        ...
        return view('front-end.gig.gig-activity', compact('gig', 'currency_symbol', 'dispute_detail', 'disputeIssues','slug', 'title'));
    }
    ...
    public function GigOrderCompletion(Request $request){
        ...
        } elseif( array_key_exists($payment_method, $gateways) ) {
