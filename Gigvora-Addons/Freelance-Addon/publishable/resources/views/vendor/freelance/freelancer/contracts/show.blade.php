...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/freelance/freelancer/contracts">Contracts</a></li>
...
<div class="container py-4" id="contract-detail" data-contract-id="{{ $contract['id'] ?? '' }}">
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <p class="text-muted mb-1">Client: {{ $contract['client'] ?? '' }}</p>
            ...
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">Funded → Submitted → Released</small>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                <div class="card-body">
                    <h6>Escrow</h6>
                    <p class="mb-1">Funded: {{ $contract['escrow'] ?? '$0' }}</p>
                    <p class="mb-0">Status: <span class="badge bg-light text-dark">{{ $contract['escrow_status'] ?? 'Pending' }}</span></p>
                </div>
            </div>
            <div class="card">
                <div class="card-body d-grid gap-2">
                    <button class="btn btn-outline-success" data-action="complete-milestone">Mark Milestone as Complete</button>
                    <button class="btn btn-outline-primary" data-action="request-release">Request Release</button>
                    <button class="btn btn-outline-danger" data-action="open-dispute">Open Dispute</button>
                </div>
            </div>
        </div>
    </div>
