                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: [
                                  ...
                                  InfoChip(label: webinar.canReplay ? 'Replay ready' : 'Replay gated for attendees'),
                                ],
                              ),
                            ],
                          ),
                      ...
                      const SizedBox(height: 16),
                      if (webinar.recordings.isEmpty)
                        Text(
                          webinar.canReplay
                              ? 'Replay will appear here once processing completes.'
                              : 'Register with the right ticket to unlock the replay when it drops.',
                          style: Theme.of(context)
                              .textTheme
                              .bodyMedium
                              ?.copyWith(color: LiveMobileTheme.mutedText(context)),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(isRegistered
                                  ...
                                  : 'Registered. Reminders and waiting room unlocked.'),
                            ),
                          );
                          Navigator.pushNamed(
                            context,
