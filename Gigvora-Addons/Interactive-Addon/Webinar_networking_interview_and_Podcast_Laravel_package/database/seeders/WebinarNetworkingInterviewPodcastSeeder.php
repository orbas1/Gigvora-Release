    ...
    public function run(): void
    {
        ...
        foreach (range(1, 3) as $index) {
            Webinar::updateOrCreate(
                ['host_id' => $hostId, 'title' => "Sample Webinar {$index}"],
                [
        ...
        foreach (range(1, 2) as $index) {
            NetworkingSession::updateOrCreate(
                ['host_id' => $hostId, 'title' => "Speed Networking {$index}"],
                [
        ...
        foreach (range(1, 2) as $index) {
            PodcastSeries::updateOrCreate(
                ['host_id' => $hostId, 'title' => "Podcast Series {$index}"],
                [
        ...
        foreach (range(1, 2) as $index) {
            Interview::updateOrCreate(
                ['host_id' => $hostId, 'title' => "Interview Round {$index}"],
                [
