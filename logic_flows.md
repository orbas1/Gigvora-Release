...
- Interviews now surface a dedicated live route (`wnip.interviews.live`) so waiting rooms unlock the correct CTA when the scheduled slot starts; countdown pills and accessibility states are driven by the same timers used on Flutter.
