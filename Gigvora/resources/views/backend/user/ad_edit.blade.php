      ...
      <div class="col-6">
        <div class="eSection-wrap-2">
          <div class="eForm-layouts">
            ...
            <form method="POST" action="{{ route('user.ad.update', $ad->id) }}" enctype="multipart/form-data">
              @if ($errors->any())
              ...
              @endif
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control eForm-control" value="{{$ad->name}}" id="name" name="name" placeholder="Title" required>
                </div>
                <div class="mb-3">
                  <label for="ext_url" class="form-label eForm-label">{{ get_phrase('URL') }}</label>
                  <input type="url" class="form-control eForm-control" value="{{$ad->ext_url}}" id="ext_url" name="ext_url" placeholder="URL">
                </div>
                <div class="mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control eForm-control content" placeholder="Description">{{$ad->description}}</textarea>
                </div>
