...
class AdminCrudController extends Controller
{
    ...
    public function about()
    {
        ...
        $returnable_array = array(
            'purchase_code_status' => get_phrase('Not required'),
            'support_expiry_date' => get_phrase('Lifetime'),
            'customer_name' => $purchase_code ? $purchase_code : get_phrase('Gigvora'),
    ...
    {
        // External purchase code checks have been removed for Gigvora deployments
        return true;
    }
