    ...
    @if ($entry['status'] === 'completed')
        ...
        <div class="lqd-image-result-actions mt-auto flex w-full items-center justify-center gap-3">
            ...
            <x-button
                ...
                variant="ghost-shadow"
                size="none"
                onclick="return confirm('{{ __('Are you sure? This action is permanent and will delete the AiAvatarPro related document for the user.') }}')"
                :href="LaravelLocalization::localizeUrl(route('dashboard.user.ai-avatar-pro.delete', $entry['video_id']))"
            >
