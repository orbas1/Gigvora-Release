    ...
    <div class="py-10">
        <div class="mx-auto w-full md:w-8/12 xl:w-5/12">
            ...
            <div x-data="{
                ...
                <div>
                    @include('chat-setting::chatbot.particles.web-site-tab')
                    @include('chat-setting::chatbot.particles.pdf-tab')
                    @include('chat-setting::chatbot.particles.text-tab')
                    @include('chat-setting::chatbot.particles.qa-tab')
                </div>
            </div>
        </div>
