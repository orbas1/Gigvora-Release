    ...
    <section class="tk-searchproject-section tk-main-bg" aria-label="{{ __('Freelance project search') }}">
        <div class="container">
            <div class="row">
                ...
                @endphp
                <livewire:project.search-projects :price_range="$price_range" :keyword="$keyword" :category_id="$category_id" :project_min_price="$project_min_price" :project_max_price="$project_max_price" :authorId="$authorId" />
            </div>
        </div>
    </section>
@endsection
        ...
        window.onload = (event) => {
            ...
            jQuery(document).ready(function() {
                ...
                $(document).on('click', '#clearFilters', function(event) {
                    ...
                    applyFilter = true
                    $('#clearFilters').addClass('d-none');
                    var isAuthorFilter = (new URL(location.href)).searchParams.get('author_id');
                    console.log(isAuthorFilter);
                    if (isAuthorFilter) {
                        window.location.href = '{{ route("search-projects") }}';
                    }
                });
