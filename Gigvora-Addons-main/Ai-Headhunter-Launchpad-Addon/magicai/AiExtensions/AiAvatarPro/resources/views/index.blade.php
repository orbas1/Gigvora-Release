...
@section('titlebar_subtitle', __('Create studio-quality videos with AI Avatar Pro and voiceovers in 130+ languages. It’s as easy as making a slide deck.'))
@section('titlebar_actions')
    <x-button href="{{ LaravelLocalization::localizeUrl(route('dashboard.user.ai-avatar-pro.create')) }}">
    ...
    <div class="py-10">
        ...
        >
            <div class="w-full self-center p-10 lg:w-6/12 lg:p-14">
                <h3 class="mb-8 leading-6">
                    @lang('Create engaging videos with AI Avatar Pro and voiceovers in 130+ languages.')
                </h3>
        ...
        >
            ...
            <div id="videos-container">
                @include('ai-avatar-pro::videos-list', ['list' => $list])
            </div>
...
<script>
    function checkVideoStatus() {
        fetch('{!! route('dashboard.user.ai-avatar-pro.check', ['ids' => $inProgress]) !!}')
